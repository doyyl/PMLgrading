...
const ROLES: RoleConfig[] = [
  {
    ...
    iconBg: 'bg-blue-600',
    border: 'hover:border-blue-400 focus:border-blue-500',
  ...
  },
  {
    ...
    border: 'hover:border-emerald-400 focus:border-emerald-500',
  ...
  },
  {
    ...
    border: 'hover:border-purple-400 focus:border-purple-500',
          ...
          <div className="w-full max-w-4xl grid grid-cols-1 md:grid-cols-3 gap-4">
            {ROLES.map((cfg) => (
              <button
                ...
                className={`group relative flex flex-col rounded-2xl border border-white/10 bg-white/5 p-6 text-left backdrop-blur-sm transition-all duration-200 hover:bg-white/10 hover:border-white/20 hover:scale-[1.02] hover:shadow-2xl active:scale-[0.99] focus:outline-none ${cfg.border}`}
              >
                {/* Role badge */}
